...
private:
    ...
    ZipWorkerInfo getZipInfo(const QString &file_path, const QStringList &db_file_path_list);
...
public slots:
    void receive_getFileJsonInfo_request(const QString &file_path, const QStringList &db_file_path_list);
    void receive_getDirJsonInfo_request(const QString &dir_path, const QStringList &db_file_path_list);
